...
public class SigninStepDef {
  ...
  public void user_is_redirected_Login_page() throws Throwable {
    try {
  ...
  public void enters_valid_credentials_and_click_on_Signin_button() throws Throwable {
    try {
      ...
      Thread.sleep(2000);
      customMessage = "Verifying the login";log.info("Start of the Scenario Home Page title Verification");
